...
export declare class MigrateEngine {
     ...
     */
    createDatabase(args: EngineArgs.CreateDatabaseInput): Promise<EngineResults.CreateDatabaseOutput>;
    /**
     ...
     */
    dbExecute(args: EngineArgs.DbExecuteInput): Promise<EngineResults.DbExecuteOutput>;
    /**
     ...
     */
    ensureConnectionValidity(args: EngineArgs.EnsureConnectionValidityInput): Promise<void>;
    /**
     ...
     */
    introspect({ schema, force, compositeTypeDepth, // cannot be undefined
    schemas, }: EngineArgs.IntrospectParams): Promise<EngineArgs.IntrospectResult>;
    /**
     ...
     */
    migrateDiff(args: EngineArgs.MigrateDiffInput): Promise<EngineResults.MigrateDiffOutput>;
    /**
