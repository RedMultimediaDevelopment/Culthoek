...
export type User = {
  ...
  isPresentLaunchParty: boolean | null
  email: string
}
...
/**
   ...
   * `prisma.eventTicket`: Exposes CRUD operations for the **EventTicket** model.
    ...
    * ```
    */
  get eventTicket(): Prisma.EventTicketDelegate<GlobalReject>;
...
export namespace Prisma {
  ...
  */
  ...
  export type EventTicketAggregateArgs = {
     ...
     */
    orderBy?: Enumerable<EventTicketOrderByWithRelationInput>
    /**
  ...
  export type EventTicketGroupByArgs = {
    where?: EventTicketWhereInput
    orderBy?: Enumerable<EventTicketOrderByWithAggregationInput>
    by: EventTicketScalarFieldEnum[]
  ...
  type GetEventTicketGroupByPayload<T extends EventTicketGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<EventTicketGroupByOutputType, T['by']> &
        {
  ...
  export type EventTicketGetPayload<S extends boolean | null | undefined | EventTicketArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? EventTicket :
    S extends undefined ? never :
    S extends { include: any } & (EventTicketArgs | EventTicketFindManyArgs)
    ? EventTicket 
    : S extends { select: any } & (EventTicketArgs | EventTicketFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof EventTicket ? EventTicket[P] : never
  } 
      : EventTicket


  type EventTicketCountArgs = 
    Omit<EventTicketFindManyArgs, 'select' | 'include'> & {
      select?: EventTicketCountAggregateInputType | true
    }

  export interface EventTicketDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends EventTicketFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, EventTicketFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'EventTicket'> extends True ? Prisma__EventTicketClient<EventTicketGetPayload<T>> : Prisma__EventTicketClient<EventTicketGetPayload<T> | null, null>
    ...
    **/
    findUniqueOrThrow<T extends EventTicketFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, EventTicketFindUniqueOrThrowArgs>
    ): Prisma__EventTicketClient<EventTicketGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends EventTicketFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, EventTicketFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'EventTicket'> extends True ? Prisma__EventTicketClient<EventTicketGetPayload<T>> : Prisma__EventTicketClient<EventTicketGetPayload<T> | null, null>
    ...
    **/
    findFirstOrThrow<T extends EventTicketFindFirstOrThrowArgs>(
      args?: SelectSubset<T, EventTicketFindFirstOrThrowArgs>
    ): Prisma__EventTicketClient<EventTicketGetPayload<T>>
    ...
    **/
    findMany<T extends EventTicketFindManyArgs>(
      args?: SelectSubset<T, EventTicketFindManyArgs>
    ): Prisma.PrismaPromise<Array<EventTicketGetPayload<T>>>
    ...
    **/
    create<T extends EventTicketCreateArgs>(
      args: SelectSubset<T, EventTicketCreateArgs>
    ): Prisma__EventTicketClient<EventTicketGetPayload<T>>
    ...
    **/
    createMany<T extends EventTicketCreateManyArgs>(
      args?: SelectSubset<T, EventTicketCreateManyArgs>
    ...
    **/
    delete<T extends EventTicketDeleteArgs>(
      args: SelectSubset<T, EventTicketDeleteArgs>
    ): Prisma__EventTicketClient<EventTicketGetPayload<T>>
    ...
    **/
    update<T extends EventTicketUpdateArgs>(
      args: SelectSubset<T, EventTicketUpdateArgs>
    ): Prisma__EventTicketClient<EventTicketGetPayload<T>>
    ...
    **/
    deleteMany<T extends EventTicketDeleteManyArgs>(
      args?: SelectSubset<T, EventTicketDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
    ...
    **/
    updateMany<T extends EventTicketUpdateManyArgs>(
      args: SelectSubset<T, EventTicketUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
    ...
    **/
    upsert<T extends EventTicketUpsertArgs>(
      args: SelectSubset<T, EventTicketUpsertArgs>
    ): Prisma__EventTicketClient<EventTicketGetPayload<T>>

    /**
     * Find zero or more EventTickets that matches the filter.
     * @param {EventTicketFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const eventTicket = await prisma.eventTicket.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: EventTicketFindRawArgs
    ): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a EventTicket.
     * @param {EventTicketAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const eventTicket = await prisma.eventTicket.aggregateRaw({
     *   pipeline: [
    ...
    **/
    aggregateRaw(
      args?: EventTicketAggregateRawArgs
    ): Prisma.PrismaPromise<JsonObject>
   ...
   */
  export class Prisma__EventTicketClient<T, Null = never> implements Prisma.PrismaPromise<T> {
  ...
  /**
   * EventTicket base type for findUnique actions
   */
  export type EventTicketFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the EventTicket
     */
    select?: EventTicketSelect | null
    /**
   ...
   */
  export interface EventTicketFindUniqueArgs extends EventTicketFindUniqueArgsBase {
   /**
  ...
  /**
   * EventTicket base type for findFirst actions
   */
  export type EventTicketFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the EventTicket
     */
    select?: EventTicketSelect | null
     ...
     */
    distinct?: Enumerable<EventTicketScalarFieldEnum>
  }

  /**
   * EventTicket findFirst
   */
  export interface EventTicketFindFirstArgs extends EventTicketFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
  ...
  export type EventTicketCreateManyArgs = {
     ...
     */
    data: Enumerable<EventTicketCreateManyInput>
  }
   ...
   * EventTicket findRaw
   */
  export type EventTicketFindRawArgs = {
    /**
  ...
  /**
   * EventTicket aggregateRaw
   */
  export type EventTicketAggregateRawArgs = {
    /**
  ...
  export const UserScalarFieldEnum: {
    ...
    isPresentLaunchParty: 'isPresentLaunchParty',
    email: 'email'
  };
  ...
  export type EventTicketWhereInput = {
    AND?: Enumerable<EventTicketWhereInput>
    OR?: Enumerable<EventTicketWhereInput>
    NOT?: Enumerable<EventTicketWhereInput>
  ...
  export type EventTicketScalarWhereWithAggregatesInput = {
    AND?: Enumerable<EventTicketScalarWhereWithAggregatesInput>
    OR?: Enumerable<EventTicketScalarWhereWithAggregatesInput>
    NOT?: Enumerable<EventTicketScalarWhereWithAggregatesInput>
  ...
  export type UserWhereInput = {
    ...
    id?: StringFilter | string
    birthYear?: StringNullableFilter | string | null
    ...
    isPresentLaunchParty?: BoolNullableFilter | boolean | null
  ...
  export type UserOrderByWithRelationInput = {
    ...
    isPresentLaunchParty?: SortOrder
    email?: SortOrder
  }
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter | string
    birthYear?: StringNullableWithAggregatesFilter | string | null
    ...
    isPresentLaunchParty?: BoolNullableWithAggregatesFilter | boolean | null
  ...
  export type UserUpdateInput = {
    ...
    isPresentLaunchParty?: NullableBoolFieldUpdateOperationsInput | boolean | null
